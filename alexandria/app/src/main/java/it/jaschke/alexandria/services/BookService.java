...
public class BookService extends IntentService {
    ...
    //moved these constants to top of the class
    ...
    //added annotations for status updates
    ...
    private void setBookServiceStatus(@BookServiceStatus int status) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(BookService.this);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putInt(getString(R.string.preferences_book_service_status_key), status);
        editor.commit();
    }
}